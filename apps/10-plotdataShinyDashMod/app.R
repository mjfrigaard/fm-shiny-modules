# ===================================================#
# File name: app.R
# This is code to create: plotdataShinyDashApp (modules)
...
dataShinyDashUI <- function(id) {
  tagList(
    dashboardPage(
      ...
      header = dashboardHeader(title = "plotdataShinyDashApp"),
      body = dashboardBody(
        fluidRow(
          box(
            width = 12,
...
# plotdataShinyDashApp -----------------
plotdataShinyDashApp <- function() {
  
  ui <- tagList(
      # plotShinyDashUI module
      plotShinyDashUI(id = "graph"),
      # dataShinyDashUI module
      dataShinyDashUI(id = "data")
  )

  server <- function(input, output, session) {
    # plotShinyDashServer module
    plotShinyDashServer(id = "graph")
    # dataShinyDashServer module
    dataShinyDashServer(id = "data")
  }
